...
import com.sueed.exp_mid.Alarm.AlarmReceiver;
import com.sueed.exp_mid.Alarm.EditAlarmActivity;
import com.sueed.exp_mid.Alarm.Plan;
import com.sueed.exp_mid.Alarm.PlanAdapter;
import com.sueed.exp_mid.Alarm.PlanDatabase;
...
public class MainActivity extends BaseActivity implements OnItemClickListener, OnItemLongClickListener {
    ...
    public void refreshListView() {
        ...
        com.sueed.exp_mid.Alarm.CRUD op1 = new com.sueed.exp_mid.Alarm.CRUD(context);
        op1.open();
        if(planList.size() > 0) {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (returnMode == 1) {  //update current note
            ...
            plan.setId(note_Id);
            com.sueed.exp_mid.Alarm.CRUD op = new com.sueed.exp_mid.Alarm.CRUD(context);
            op.open();
            op.updatePlan(plan);
            op.close();
